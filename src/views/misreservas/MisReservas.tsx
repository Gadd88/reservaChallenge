...
export const MisReservas:React.FC = ():ReactNode => {
  ...
  return (
    <div className='mx-auto flex flex-col items-start justify-start min-w-80 w-[99%] max-w-[99%] h-full'>
      ...
      <ul className='w-full p-5 flex flex-col items-center justify-start gap-2 min-h-80 mt-5 max-w-[700px] md:flex-row md:items-center md:justify-center md:flex-nowrap'>
        {
