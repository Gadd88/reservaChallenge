...
export const BtnAction: React.FC<BtnProps> = ({type}) => {
  ...
  return (
    <button 
        className={`${type == 'continue' ? 'bg-pink-500 hover:bg-pink-600 text-white': 'bg-pink-50 hover:bg-pink-200'} p-2 w-36 mt-10 border-pink-400 font-semibold  border-2 flex items-center justify-center gap-2`}
