...
export const Nav = () => {
  return (
    <nav className="mt-2 flex justify-center items-center gap-2">
        ...
        <NavLink className='rounded-md p-3 bg-pink-500 text-white text-sm' to='/misreservas'>Mis Reservas</NavLink>
    </nav>
  )
}
